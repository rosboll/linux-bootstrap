...
# 'make smoke'  — run the full bootstrap inside a Debian 13 container with
#                 BOOTSTRAP_SMOKE=1 so credential/hardware steps skip.
...
.PHONY: help lint smoke smoke-build smoke-shell clean

help:
	@echo "Targets:"
	@echo "  lint         shellcheck all *.sh"
	@echo "  smoke        run bootstrap end-to-end in a Debian 13 container"
